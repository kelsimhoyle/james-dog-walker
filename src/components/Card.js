...
const Card = ({ img, content, btn, title }) => {
    return (
        <div className="mt-16 py-4 px-4 bg-whit w-96 bg-white rounded-xl shadow-lg hover:shadow-xl transform hover:scale-110 transition duration-500 mx-auto md:mx-0">
