...
const TwoCta = ({one, two}) => {
    return (
        ...
        <div className="rounded-md shadow">
            <Link to={one.href} className="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-green-500 hover:bg-green-600 md:py-4 md:text-lg md:px-10">
                {one.text}
            </Link>
        </div>
