                ...
                <div className="max-w-6xl mx-auto sm:px-6 lg:px-8">
                    <div className="mt-8 overflow-hidden">
                        <div className="grid grid-cols-1 md:grid-cols-2 shadow-md">
                            <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-l-lg">
                                ...
                                <div className="flex items-center mt-2 text-gray-600 dark:text-gray-400">
                                    ...
                                    <div className="ml-4 text-md tracking-wide font-semibold w-40">
                                        info@jamesthedogwalker.com
                                    </div>
                                </div>
                            </div>

                            <form className="p-6 flex flex-col justify-center bg-white rounded-r-lg">
                                ...
                                <div className="flex flex-col mt-2">
                                    ...
                                    <input type="tel" name="tel" id="tel" placeholder="Telephone Number" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-green-500 focus:outline-none" />
                                </div>

                                <div className="flex flex-col mt-2">
                                    <label for="message" className="hidden">Message</label>
                                    <input type="text" name="message" id="message" placeholder="Message" className="w-100 mt-2 py-3 px-3 rounded-lg bg-white dark:bg-gray-800 border border-gray-400 dark:border-gray-700 text-gray-800 font-semibold focus:border-green-500 focus:outline-none" />
                                </div>
