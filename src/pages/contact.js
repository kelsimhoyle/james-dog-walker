...
const Contact = ({ data }) => {
  ...
  return (
    <>
      <Seo title="James the Dog Walker - Contact" />
      <div className="relative flex items-top justify-center min-h-screen bg-green-300 dark:bg-gray-900 p-2 sm:items-center sm:pt-0">
        <div className="w-6xl mx-auto p-2 lg:px-8">
          <div className="mt-8 overflow-hidden ">
            <div className="grid grid-cols-1 md:grid-cols-2 shadow-md">
              <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-t-lg md:rounded-l-lg md:rounded-t-none flex flex-col content-center justify-center justify-items-center  ">
                <ContactInfo
